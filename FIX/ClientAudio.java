 ...
 * @author NuH
 */
public class ClientAudio extends javax.swing.JFrame {
    ...
    public void client() throws IOException, InterruptedException, UnsupportedAudioFileException {
        try {
            Socket socket = new Socket("localhost", 13085);
            java.io.OutputStream outputStream = socket.getOutputStream();
            // File f=new File ("f:/b.jpg");
   //         BufferedImage image = ImageIO.read(new File(input.getText().toString()));
            InputStream ino = new FileInputStream(input.getText().toString());
            //               OutputStream out = new FileOutputStream(file2);
            AudioInputStream in = AudioSystem.getAudioInputStream(ino);
...
//            ImageIO.write(image, "jpg", byteArrayOutputStream);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ClientAudio().setVisible(true);
            }
        });
